...
try:
    ...
    def check_password():
        ...
        if "password_correct" not in st.session_state:
            ...
            with col_m:
                ...
                st.info("💡 **提示**: 密码是6位数字")
                st.caption("如有疑问针对重置密码，请发送邮件至: [xuchunli@gmail.com](mailto:xuchunli@gmail.com)")
            return False
    ...
    if check_password():
        ...
        with st.sidebar:
            ...
            if not api_key:
                st.warning("⚠️ 未检测到 OpenAI Key，AI 自动排序将不可用。请在 Secrets 中配置以启用。")
